...
public class CraftEventFactory {
    ...
    public static PlayerInteractEvent callPlayerInteractEvent(EntityHuman who, Action action, ItemStack itemstack) {
        ...
        return callPlayerInteractEvent(who, action, new BlockPosition(0, 256, 0), itemstack);
    }
    ...
    public static PlayerInteractEvent callPlayerInteractEvent(EntityHuman who, Action action, BlockPosition position, ItemStack itemstack) {
        return callPlayerInteractEvent(who, action, position, itemstack, false);
    }
