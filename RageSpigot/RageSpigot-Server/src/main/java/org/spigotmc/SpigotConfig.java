...
public class SpigotConfig
{
    ...
    public static boolean enableMassPacketHacking;
    ...
    private static void knockbackExtraHorizontal(){
        knockbackExtraHorizontal = getDouble("settings.knockback-extra-horizontal", 0.425D);
    }

    private static void knockbackExtraVertical(){
        knockbackExtraVertical = getDouble("settings.knockback-extra-vertical", 0.085D);
    }

    private static void knockbackFriction(){
        knockbackFriction = getDouble("settings.knockback-friction", 2.0D);
    }

    private static void knockbackHorizontal(){
        knockbackHorizontal = getDouble("settings.knockback-horizontal", 0.35D);
    }

    private static void knockbackVertical(){
        knockbackVertical = getDouble("settings.knockback-vertical", 0.35D);
    }

    private static void knockbackVerticalLimit(){
        knockbackVerticalLimit = getDouble("settings.knockback-vertical-limit", 0.4D);
    }
