...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
    ...
    public void m() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            this.n();
            f = 0.2F / (float) (FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 10.0F + 1.0F);
            ...
            if (this.ce()) {
                ...
                if (this.world.isClientSide) {
                    ...
                    d0 /= (double) FastMath.sqrt(d3 * d3 + d1 * d1);
                    f3 = 0.6F;
                    ...
                    Vec3D vec3d1 = (new Vec3D((double) FastMath.sin(this.yaw * 3.1415927F / 180.0F), this.motY, d4)).a();
                    ...
                    this.bb *= 0.8F;
                    float f5 = (float) FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ) * 1.0F + 1.0F;
                ...
                float f9 = (float) -FastMath.sin(f1);
                float f10 = this.yaw * 3.1415927F / 180.0F;
                float f11 = (float) FastMath.sin(f10);
                ...
                f3 = (float) FastMath.sin(this.yaw * 3.1415927F / 180.0F - this.bb * 0.01F);
                ...
                for (int j = 0; j < 3; ++j) {
                    ...
                    float f15 = (float) FastMath.sin(f14);
    ...
    public boolean a(EntityComplexPart entitycomplexpart, DamageSource damagesource, float f) {
        ...
        float f2 = (float) FastMath.sin(f1);
