...
public class WorldManager implements IWorldAccess {
    ...
    public void a(EntityHuman entityhuman, String s, double d0, double d1, double d2, float f, float f1) {
        // Paper start - fix invisible players hearing other sounds
    ...
    public void a(EntityHuman entityhuman, int i, BlockPosition blockposition, int j) {
        // Paper start - fix invisible players seeing world events
        if (i == 2001) {
            ...
            this.a.getPlayerList().sendPacketNearbyIncludingSelf(entityhuman, (double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ(), 64.0D, this.world.dimension, new PacketPlayOutWorldEvent(i, blockposition, j, false));
        }
        // Paper end
    }
