...
import gg.ragemc.spigot.event.potion.PotionEffectAddEvent;
import gg.ragemc.spigot.event.potion.PotionEffectExpireEvent;
import gg.ragemc.spigot.event.potion.PotionEffectExtendEvent;
import gg.ragemc.spigot.event.potion.PotionEffectRemoveEvent;
import gg.ragemc.spigot.knockback.KnockbackProfile;
import gg.ragemc.spigot.util.CraftPotionUtil;
...
public abstract class EntityLiving extends Entity {
    ...
    // CraftBukkit end
    private boolean applyingSprintKnockback = false; // Paper - fix player sprint hit desync
...
//                    flag = false;
    ...
    protected void bF() {
        ...
        if (this.isSprinting()) {
            ...
            this.motX -= (double) (FastMath.sin(f) * 0.2F);
