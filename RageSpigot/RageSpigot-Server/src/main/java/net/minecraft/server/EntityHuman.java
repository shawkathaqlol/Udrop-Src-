...
public abstract class EntityHuman extends EntityLiving {
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource != null) {
            ...
            this.motZ = (double) (-FastMath.sin((this.aw + this.yaw) * 3.1415927F / 180.0F) * 0.1F);
        } else {
    ...
    public EntityItem a(ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack == null) {
            ...
            if (flag) {
                ...
                entityitem.motX = (double) (-FastMath.sin(f1) * f);
                entityitem.motZ = (double) (MathHelper.cos(f1) * f);
                entityitem.motY = 0.20000000298023224D;
            } else {
                f = 0.3F;
                entityitem.motX = (double) (-FastMath.sin(this.yaw / 180.0F * 3.1415927F) * MathHelper.cos(this.pitch / 180.0F * 3.1415927F) * f);
                entityitem.motZ = (double) (MathHelper.cos(this.yaw / 180.0F * 3.1415927F) * MathHelper.cos(this.pitch / 180.0F * 3.1415927F) * f);
                entityitem.motY = (double) (-FastMath.sin(this.pitch / 180.0F * 3.1415927F) * f + 0.1F);
                f1 = this.random.nextFloat() * 3.1415927F * 2.0F;
            ...
            if (f > 0.0F || f1 > 0.0F) {
                ...
                if (flag2) {
                    if (i > 0)
                    {
                        ...
                        entity.g((-FastMath.sin(this.yaw * 3.1415927F / 180.0F) * (float) i * SpigotConfig.knockbackExtraHorizontal),
    ...
    public void checkMovement(double d0, double d1, double d2) {
        if (this.vehicle == null) {
            ...
            if (this.a(Material.WATER)) {
                i = (int) Math.round(FastMath.sqrt(d0 * d0 + d1 * d1 + d2 * d2) * 100.0F);
                if (i > 0) {
                ...
                i = (int) Math.round(FastMath.sqrt(d0 * d0 + d2 * d2) * 100.0F);
                if (i > 0) {
    ...
    private void l(double d0, double d1, double d2) {
        if (this.vehicle != null) {
            int i = (int) Math.round(FastMath.sqrt(d0 * d0 + d1 * d1 + d2 * d2) * 100.0F);
