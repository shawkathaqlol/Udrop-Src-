...
public class EntityFishingHook extends Entity {
    ...
    public EntityFishingHook(World world, EntityHuman entityhuman) {
        ...
        this.motX = (double) (-FastMath.sin(this.yaw / 180.0F * 3.1415927F) * MathHelper.cos(this.pitch / 180.0F * 3.1415927F) * f);
        this.motZ = (double) (MathHelper.cos(this.yaw / 180.0F * 3.1415927F) * MathHelper.cos(this.pitch / 180.0F * 3.1415927F) * f);
        this.motY = (double) (-FastMath.sin(this.pitch / 180.0F * 3.1415927F) * f);
                    ...
                    if (this.av > 0) {
                        ...
                        if (this.ax > 0) {
                            ...
                            if (this.random.nextFloat() < f3) {
                                ...
                                d8 = this.locX + (double) (FastMath.sin(f5) * f4 * 0.1F);
                                d12 = (double) ((float) MathHelper.floor(this.getBoundingBox().b) + 1.0F);
    ...
    public int l() {
        if (this.world.isClientSide) {
            ...
            if (this.hooked != null) {
                ...
                double d3 = (double) FastMath.sqrt(d0 * d0 + d1 * d1 + d2 * d2);
                double d4 = 0.1D;

                this.hooked.motX += d0 * d4;
                this.hooked.motY += d1 * d4 + (double) FastMath.sqrt(d3) * 0.08D;
                ...
                double d8 = (double) FastMath.sqrt(d5 * d5 + d6 * d6 + d7 * d7);
                double d9 = 0.1D;

                entityitem.motX = d5 * d9;
                entityitem.motY = d6 * d9 + (double) FastMath.sqrt(d8) * 0.08D;
