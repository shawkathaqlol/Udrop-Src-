...
import gg.ragemc.spigot.RageSpigotConfig;
...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    protected boolean init() throws IOException {
        ...
        if (false && !eulaAgreed) { // Spigot
            ...
            RageSpigot.INSTANCE.setConfig(new RageSpigotConfig());
            RageSpigot.INSTANCE.registerCommands();
            ...
            if (!NameReferencingFileConverter.a(this.propertyManager)) {
                ...
                this.aK();
                this.setServerIP(this.propertyManager.getInt("max-build-height", 256));
                this.setServerIP((this.getMaxBuildHeight() + 8) / 16 * 16);
                this.setServerIP(MathHelper.clamp(this.getMaxBuildHeight(), 64, 256));
