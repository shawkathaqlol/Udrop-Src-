    ...
    public void m() {
        ...
        if (this.inWater) {
            ...
            if (this.bl < 3.1415927F) {
                ...
                this.bn = (float) FastMath.sin(f * f * 3.1415927F) * 3.1415927F * 0.25F;
                if ((double) f > 0.75D) {
                    this.bp = 1.0F;
                    this.br = 1.0F;
                } else {
            ...
            this.bn = MathHelper.e((float) FastMath.sin(this.bl)) * 3.1415927F * 0.25F;
            if (!this.world.isClientSide) {
                this.motX = 0.0D;
                this.motY -= 0.08D;
    ...
    static class PathfinderGoalSquid extends PathfinderGoal {
        ...
        public void e() {
            ...
            if (i > 100) {
                ...
                float f3 = (float) FastMath.sin(f) * 0.2F;
