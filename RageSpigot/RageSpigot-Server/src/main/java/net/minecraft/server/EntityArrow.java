...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public EntityArrow(World world, EntityLiving entityliving, EntityLiving entityliving1, float f, float f1) {
        ...
        double d3 = (double) FastMath.sqrt(d0 * d0 + d2 * d2);
    ...
    public EntityArrow(World world, EntityLiving entityliving, float f) {
        ...
        this.motX = (double) (-FastMath.sin(this.yaw / 180.0F * 3.1415927F) * MathHelper.cos(this.pitch / 180.0F * 3.1415927F));
        this.motZ = (double) (MathHelper.cos(this.yaw / 180.0F * 3.1415927F) * MathHelper.cos(this.pitch / 180.0F * 3.1415927F));
        this.motY = (double) (-FastMath.sin(this.pitch / 180.0F * 3.1415927F));
        ...
        if (this.inGround) {
            ...
            if (movingobjectposition != null) {
                ...
                if (movingobjectposition.entity != null) {
                    f2 = (float) FastMath.sqrt(this.motX * this.motX + this.motY * this.motY + this.motZ * this.motZ);
                    ...
                    // if (movingobjectposition.entity.damageEntity(damagesource, (float) k)) { // CraftBukkit - moved up
                        if (movingobjectposition.entity instanceof EntityLiving) {
                            ...
                            if (this.knockbackStrength > 0) {
                                f3 = (float) FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ);
                                if (f3 > 0.0F) {
                    ...
                    f1 = (float) FastMath.sqrt(this.motX * this.motX + this.motY * this.motY + this.motZ * this.motZ);
            ...
            this.locY += this.motY;
            this.locZ += this.motZ;
            f2 = (float) FastMath.sqrt(this.motX * this.motX + this.motZ * this.motZ);
