...
public class PlayerInteractManager {
    ...
    public void a(BlockPosition blockposition, EnumDirection enumdirection) {
        ...
        PlayerInteractEvent event = CraftEventFactory.callPlayerInteractEvent(this.player, Action.LEFT_CLICK_BLOCK, blockposition, this.player.inventory.getItemInHand());
    ...
    public boolean interact(EntityHuman entityhuman, World world, ItemStack itemstack, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2) {
        ...
        if (blockdata.getBlock() != Blocks.AIR) {
            ...
            PlayerInteractEvent event = CraftEventFactory.callPlayerInteractEvent(entityhuman, Action.RIGHT_CLICK_BLOCK, blockposition, itemstack, cancelledBlock);
            firedInteract = true;
